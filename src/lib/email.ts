  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:system-ui,sans-serif;max-width:480px;margin:0 auto;padding:40px 24px;background:#111514;color:#e8f0ef;border-radius:16px;">
        <div style="font-size:24px;font-weight:900;color:#6bbfb8;margin-bottom:8px;">FitSched</div>
        ...
        <a href="${url}" style="display:inline-block;background:#6bbfb8;color:#111514;font-weight:700;font-size:14px;padding:13px 28px;border-radius:12px;text-decoration:none;">
          Verify email
        </a>
