          ...
          {googleAccount ? (
            <>
              <motion.div variants={fadeIn}>
                <div style={{ width: 52, height: 52, borderRadius: 16, background: "rgba(107,191,184,0.08)", border: "1px solid rgba(107,191,184,0.2)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
